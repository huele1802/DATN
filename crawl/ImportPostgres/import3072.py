...
def read_embeddings(file_path):
    try:
        ...
        if embeddings.shape[1] != 3072:
            raise ValueError(f"Embeddings trong {file_path} phải có 3072 chiều, nhưng có {embeddings.shape[1]} chiều.")
        return embeddings
    except Exception as e:
...
if __name__ == "__main__":
    hotel_json_file = 'output3105/cleaned/hotels_cleaned.json'
    place_json_file = 'output3105/cleaned/places_img_cleaned.json'
    hotel_embeddings_file = 'output3105/embedding/hotel_embeddings_openai.npy'
    room_embeddings_file = 'output3105/embedding/room_embeddings_openai.npy'
    place_embeddings_file = 'output3105/embedding/place_embeddings_openai.npy'
